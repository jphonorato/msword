...
static csconst CHAR szCsPrvwOnePg[] = SzKey("One P&age",PrvwOnePg);
static csconst CHAR szCsPrvwTwoPg[] = SzKey("Two P&ages",PrvwTwoPg);
...
#ifdef OPUS_X64
LRESULT CALLBACK PgPrvwWndProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
#else
...
#if defined(DEBUG) || defined(OPUS_X64) /* in formatn2.asm on Win16 */

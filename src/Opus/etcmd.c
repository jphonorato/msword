...
*/
#ifdef OPUS_X64
/* The 16-bit resource compiler accepted an inferred-width, packed string
 * table and the code below recovered each string length by subtracting
 * adjacent row addresses.  Standard C does not permit that declaration.
 * Preserve the original strings as an explicit pointer table on x64. */
static csconst CHAR szPosAdj[] = "Adj.: ";
static csconst CHAR szPosNoun[] = "Noun: ";
static csconst CHAR szPosAdv[] = "Adv.: ";
static csconst CHAR szPosVerb[] = "Verb: ";
static csconst CHAR szPosEnd[] = "";
static csconst CHAR * const rgposDef[] =
	{ szPosAdj, szPosNoun, szPosAdv, szPosVerb, szPosEnd };
#else

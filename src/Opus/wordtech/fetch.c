...
PN		       C_PnFromPlcbteFc();
CHAR HUGE	       *C_HpchFromFc();
CHAR HUGE	       *C_HpchGetPn();
...
#if defined(MAC) || defined(OPUS_X64)  /* in fetchn2.asm on Win16 */
/* C A C H E  P A R A  C A */
/* alternative entry point */
/* %%Function:CacheParaCa %%Owner:davidlu */
#ifdef OPUS_X64
HANDNATIVE C_CacheParaCa(pca)
#else
...
#if defined(MAC) || defined(OPUS_X64) /* resident.asm translated for x64 */
/* L O W E R  R G C H */
...
#if defined(MAC) || defined(OPUS_X64) /* in fetchn3.asm on Win16 */
/* S E T  D I R T Y */
/* ibp in internal cache */
/* %%Function:SetDirty %%Owner:davidlu */
#ifdef OPUS_X64
HANDNATIVE C_SetDirty(ibp)
#else
...
#ifdef OPUS_X64
HANDNATIVE int C_FAbsPap(doc, ppap)
#else

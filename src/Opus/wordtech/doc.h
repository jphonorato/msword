...
#ifdef OPUS_X64
/* The generated Win16 toolbox supplied these declarations. On AMD64 they
 * must be explicit so an implicit int return cannot truncate a DOD pointer. */
struct DOD *N_PdodDoc(int doc);
struct DOD *C_PdodDoc(int doc);
struct DOD *N_PdodMother(int doc);
#endif

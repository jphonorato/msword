...
#ifdef OPUS_X64
EXPORT int PASCAL OpusOriginalWinMain( hInstance, hPrevInstance, lpszCmdLine, cmdShow )
#else
...
#ifdef OPUS_X64
LRESULT CALLBACK MwdWndProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
#else
...
#ifdef OPUS_X64
LRESULT CALLBACK WwPaneWndProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
#else

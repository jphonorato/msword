...
#ifdef OPUS_X64
csconst char stSubMain[sizeof("Sub MAIN")] = "\010Sub MAIN";
csconst char stSuper[sizeof("Super ")] = "\006Super ";
static csconst char stEndSub[sizeof("End Sub")] = "\007End Sub";
csconst char stDimAs[sizeof("Dim dlg As ")] = "\013Dim dlg As ";
csconst char stGetCurValsDlg[sizeof("GetCurValues dlg")] = "\020GetCurValues dlg";
csconst char stDialogDlg[sizeof("Dialog dlg")] = "\012Dialog dlg";
csconst char stDlg[sizeof(" dlg")] = "\004 dlg";
csconst char stMacroRun[sizeof("MacroRun \"")] = "\012MacroRun \"";
#else
...
/* V M N  V A L I D  M A C R O  N A M E */
/* %%Function:VmnValidMacroName %%Owner:bradch %%Reviewed:7/31/89 */
...
/* The Win16 linker folded this historical short spelling onto the routine
   above. Keep both source-level entry names on a case-sensitive x64 link. */
int VmnValidMacroName(stName)
char * stName;
{
	return VmnValidMacroNameSt(stName);
}
...
#ifdef OPUS_X64
csconst CHAR stGlobal[sizeof("Global")] = "\006Global";
#else

...
csconst CHAR rgszMonths[][cchMaxDateStr] = 
{
...
csconst CHAR rgszDays[][cchMaxDateStr] = 
{
	SzKey("Sunday",Sunday),
			SzKey("Monday",Monday),
...
static csconst CHAR mpmonddom[][12] =

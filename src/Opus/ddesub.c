...
#ifdef OPUS_X64
static csconst CHAR stAppDde[] = { 7, 'W', 'i', 'n', 'W', 'o', 'r', 'd' };
#else
static csconst CHAR stAppDde[] = St("WinWord");
#endif
...
#ifdef OPUS_X64
LRESULT CALLBACK DdeChnlWndProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
#else

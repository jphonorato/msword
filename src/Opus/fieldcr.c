...
#ifdef OPUS_X64
/* fieldfmt.c owns the field-type dispatch table in the x64 build. */
extern csconst struct EFLT dnflt[];
#endif
...
#if defined(NOASM) || defined(OPUS_X64)
/* I N I T  F V B */
...
#if defined(DEBUG) || defined(OPUS_X64) /* coded inline in fieldcrn.asm */

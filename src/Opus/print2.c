...
static const char stNextStyle[] = "\013NextStyle:\t";
static const char stGlsyTemplate[] = "\043Glossaries for Document Template:  ";
static const char stGlsyGlobal[] = "\021Global Glossaries";
static const char stDotKeys[] = "\050Key Assignments for Document Template:  ";
static const char stGlobalKeys[] = "\026Global Key Assignments";
#else
...
#ifdef OPUS_X64
static const struct PRSD rgprsdDef[] =
	{
	{ "\012Filename:\t", iSum, Iag(CABDOCSUM, hszFNameSum) },
	{ "\013Directory:\t", iSum, Iag(CABDOCSUM, hszDirSum) },
	{ "\012Template:\t", iStat, Iag(CABDOCSTAT, hszDOT) },
	{ "\007Title:\t", iSum, Iag(CABDOCSUM, hszTitle) },
	{ "\010Author:\t", iSum, Iag(CABDOCSUM, hszAuthor) },
	{ "\011Subject:\t", iSum, Iag(CABDOCSUM, hszSubject) },
	{ "\012Keywords:\t", iSum, Iag(CABDOCSUM, hszKeyWords) },
	{ "\012Comments:\t", iSum, Iag(CABDOCSUM, hszComments) },
	{ "\015Create Date:\t", iStat, Iag(CABDOCSTAT, hszCDate) },
	{ "\021Revision Number:\t", iStat, Iag(CABDOCSTAT, hszRevNum) },
	{ "\021Last Saved Date:\t", iStat, Iag(CABDOCSTAT, hszRDate) },
	{ "\017Last Saved By:\t", iStat, Iag(CABDOCSTAT, hszLRevBy) },
	{ "\024Total Editing Time:\t", iStat, Iag(CABDOCSTAT, hszEdMin) },
	{ "\016Last Printed:\t", iStat, Iag(CABDOCSTAT, hszLPDate) },
	{ "\034As of Last Complete Printing", iNix, 0 },
	{ "\022\tNumber of Pages:\t", iStat, Iag(CABDOCSTAT, hszCPg) },
	{ "\022\tNumber of Words:\t", iStat, Iag(CABDOCSTAT, hszCWords) },
	{ "\027\tNumber of Characters:\t", iStat, Iag(CABDOCSTAT, hszCch) }
	};
#else

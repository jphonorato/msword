...
#if defined(DEBUG) || defined(OPUS_X64_DISPLAY_C)
/* D I S P L A Y  F L I */
...
#ifdef OPUS_X64
	Assert(vfli.grpfvisi.w == grpfvisi.w);
#else
...
#if defined(DEBUG) || defined(OPUS_X64_DISPLAY_C) /* LN_DrawChVis in disp1n.asm used if not DEBUG */
/* D R A W  C H  V I S */
